...
if (localStorage.getItem("userName")) {
    ...
    localStorage.setItem("isGreet", true);
    generateMIT();
}
...
function generateMIT() {
	if (localStorage.getItem("isGreet")) {
        greet_input.style.setProperty("display","none");
        mit.style.setProperty("display","block");
	}
}
